    ...
    <head>
        ...
        <style type="text/css">
           ...
           #user_data{
            ...
            #frozens_data1 tr:nth-child(even){background-color: #f2f2f2;}
            #frozens_data1 tr:hover {background-color: #ddd;}
            #frozens_data1 th{
                  border: 1px solid #ddd;
                  padding: 8px;
                  color: white;
            ...
            #frozens_data1 tr,#frozens_data1 td{
                padding: 1px;
               font-size: 12px;
...
//          Frozon Table
            var dataTable = $('#user_data').DataTable({  
                    ...
                    "order":[],  
                    "ajax":{  
                        url:"<?php echo base_url() . 'all_plans2'; ?>",  
                        type:"POST"  
                    },  
                    "columnDefs":[  
                        {  
                ...
                function fozenChiled1(d){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo base_url().'bomLevels2';?>",
                        dataType: 'json',
...
$(document).ready(function(){
    var dataTable11 =  $('#frozens_data1').DataTable({  
        "processing":true,  
        "serverSide":true,  
        "order":[],  
        "ajax":{  
            url:"<?php echo base_url() . 'frozen_items2'; ?>",  
            type:"POST"  
        },  
        "columnDefs":[  
            {  
   ...
   $('#frozens_data1 tbody').on('click', 'td.frozens', function () {
        var tr = $(this).closest('tr');
              ...
              <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse-2">
                  <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="<?= base_url()?>Alls_Fronens_2">Frozen</a></li> 
                    <li>
